	...
	Fl_Group(X, Y, W, H, NULL)
{
	...
	Fl_Box *title = new Fl_Box(X + 40, Y + 10, W - 70, 30, "Исходные настройки");
	...
	w_tex = new UI_DynInput(X+68,   Y, 108, 24, "Стена: ");
	...
	c_tex = new UI_DynInput(X+68, Y, 108, 24, "Ячейки: ");
	...
	f_tex = new UI_DynInput(X+80, Y, 100, 24, "Потолок:   ");
	...
	light = new Fl_Int_Input(X+68, Y, 64, 24, "Свет:   ");
	...
	thing = new UI_DynInput(X+68, Y+20, 64, 24, "Объект: ");
	...
	th_sprite = new UI_Pic(X+W-90, Y, 80,80, "Спрайт");
