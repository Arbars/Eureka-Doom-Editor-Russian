...
public:
	static void Open()
	{
		...
		_instance = new UI_About(ABOUT_W, ABOUT_H, "Об Eureka v" EUREKA_VERSION);
...
const char *UI_About::Text1 =
	"EUREKA - редактор карт для классического DOOM\n"
	"Он использует код редактора Yadex";
...
const char *UI_About::Text2 =
	...
	"Перевод на русский - Артём Быстров, 2018 \n"
	"\n"
	"Эта программа - свободное ПО, и может\n"
	"распространяться и изменаться на условиях\n"
	"GNU General Public License\n"
	"\n"
	"Автор программы не даёт НИКАКИХ ГАРАНТИЙ\n"
	"Используйте её на СВОЙ РИСК.";
